...
<body>
	...
	$sql = "select * from payment where RoomID = '$RoomID' ";
	...
	<article>
		...
		<table class="meta">
			<tr>
				...
				<td><span><?php echo $RoomID; ?></span></td>
			</tr>
			<tr>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- g10@gmail.com || Web :- www.HeavenParadise.com || Phone :- +91 8888888888 </p>
		</div>
	</aside>
