...
if (isset($_POST['addstaff'])) {
    ...
    $staffwork = isset($_POST['staffwork']) ? $_POST['staffwork'] : '';

    // You should also consider sanitizing your inputs to prevent SQL injection
    $staffname = mysqli_real_escape_string($conn, $staffname);
    $staffwork = mysqli_real_escape_string($conn, $staffwork);
    ...
    if ($result) {
        ...
        echo "Error: " . mysqli_error($conn); // This will help you debug if there's any SQL error
    }
}
?>
<!DOCTYPE html>
